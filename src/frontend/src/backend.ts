...
export class Backend implements backendInterface {
    ...
    async addMedia(arg0: string, arg1: MediaType, arg2: ExternalBlob, arg3: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.addMedia(arg0, to_candid_MediaType_n8(this._uploadFile, this._downloadFile, arg1), await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg2), arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMedia(arg0: string): Promise<MediaEntry> {
        if (this.processError) {
            try {
                const result = await this.actor.getMedia(arg0);
                return from_candid_MediaEntry_n16(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async listMedia(): Promise<Array<MediaEntry>> {
        if (this.processError) {
            try {
...
async function from_candid_MediaEntry_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MediaEntry): Promise<MediaEntry> {
...
async function from_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        title: value.title,
        file: await from_candid_ExternalBlob_n18(_uploadFile, _downloadFile, value.file),
        group: value.group,
...
async function from_candid_vec_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MediaEntry>): Promise<Array<MediaEntry>> {
    return await Promise.all(value.map(async (x)=>await from_candid_MediaEntry_n16(_uploadFile, _downloadFile, x)));
}
